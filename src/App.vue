        ...
        <div class="icon-bar">
          <div class="icon-block" @click="setCurrentBlock('aboutMe')">
            <a
              :class="[
                'icon-block-link',
                { 'icon-block-link_active': currentBlock === 'aboutMe' },
              ]"
            >
          ...
          <div class="icon-block" @click="setCurrentBlock('skills')">
            <a
              :class="[
                'icon-block-link',
                { 'icon-block-link_active': currentBlock === 'skills' },
              ]"
            >
          ...
          <div class="icon-block" @click="setCurrentBlock('projects')">
            <a
              :class="[
                'icon-block-link',
                { 'icon-block-link_active': currentBlock === 'projects' },
              ]"
            >
          ...
          <div class="icon-block" @click="setCurrentBlock('win')">
            <a
              :class="[
                'icon-block-link',
                { 'icon-block-link_active': currentBlock === 'win' },
              ]"
            >
          ...
          >
            <a
              :class="[
                'icon-block-link',
                {
                  'icon-block-link_active':
                    currentBlock === 'experienceEducation',
                },
              ]"
            >
              <icon-experience class="icon-img"></icon-experience>опыт &
              образование
            </a>
          </div>
        </div>
